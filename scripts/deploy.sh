...
cleos create account eosio my.sx EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
...
cleos transfer eosio my.sx "50000.0000 EOS" "init"

# create USDT token
cleos push action eosio.token create '["eosio", "100000000.000000 USDT"]' -p eosio.token
cleos push action eosio.token issue '["eosio", "5000000.000000 USDT", "init"]' -p eosio
cleos transfer eosio my.sx "50000.000000 USDT" "init"